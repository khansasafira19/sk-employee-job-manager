        ...
        <div class="col-lg-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'owner')->widget(Select2::classname(), [
                                ...
                                'options' => ['placeholder' => 'Pilih Pegawai', 'value' => $duplikat->owner],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                    'readonly' => true
                                ],
                        ...
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'timkerjaproject')->widget(Select2::classname(), [
                                ...
                                'options' => ['placeholder' => 'Pilih Project',  'value' => $duplikat->timkerjaproject],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                ],
                    ...
                    <?= $form->field($model, 'rincian_report')->textarea(['rows' => 3, 'value' => $duplikat->rincian_report]) ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            echo DatePicker::widget([
                                ...
                                'name' => 'tanggal_kerja',
                                'options' => [
                                    'placeholder' => 'Piih tanggal ...', 'value' => date("Y-m-d")
                                ],
                                'pluginOptions' => [
                                    'todayHighlight' => true,
                                    'todayBtn' => true,
